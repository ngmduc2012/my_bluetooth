...
public class MyBluetooth: NSObject, FlutterPlugin {

    // MARK: I.Step 1: Setup method
    var talking = TalkingWithFlutter.shared

    public static func register(with registrar: FlutterPluginRegistrar) {
        let instance = MyBluetooth()
        instance.talking.methodChannel = FlutterMethodChannel.init(name: "my_bluetooth/methods", binaryMessenger: registrar.messenger())
