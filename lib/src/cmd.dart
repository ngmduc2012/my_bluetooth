...
class Cmd {
  ...
  static const List<int> baseApp = [...base, app, 0x00,];
  static const List<int> basePrinter = [...base, printer, 0x00,];
  ...
  static const List<int> endOfReceiveAckWithJobID= [...basePrinter, 0x02, 0x04];
  static const List<int> upgradeAck = [...basePrinter, 0x03, 0x02];
  static const List<int> errorMessageAck = [...basePrinter, 0x04, 0x00];
  static const List<int> errorMessageAckWithJobID = [...basePrinter, 0x04, 0x01];
